...
/**
 * Class that contains methods needed for reading values from and writing values into a TimeFlip dice.
 */
public final class Dice {
    ...
    /**
	 * Inputs the password into the TimeFlip dice. 
     * This is necessary to be able to read further values from the TimeFlip service's characteristics.
     * TimeFlip requires password input after re-connect to authorize connected device.
     * The default password is ASCII "000000" or {0x30, 0x30, 0x30, 0x30, 0x30, 0x30}.
	 * 
    ...
    /**
	 * Reads the battery level from the TimeFlip dice. 
     * The battery level can be any number from 0 to 100.
	 * 
    ...
    public int readBatteryLevel() {
        ...
        if(batteryService != null) {
            ...
            BluetoothGattCharacteristic batteryLevelCharacteristic = batteryService.find(batteryLevelCharacteristicUuid);
    ...
    /**
	 * Enables notifications for when the TimeFlip dice lands on a new facet after being rolled or tilted.
	 * 
