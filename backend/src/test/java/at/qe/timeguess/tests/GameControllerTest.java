...
public class GameControllerTest {
	...
	public void testGetAllRunningGames() {
		...
		ResponseEntity<Integer> success = gameController.createGame(new CreateGame("testId", 0, null, 2, 30));
